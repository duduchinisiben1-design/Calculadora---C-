...
while (true == true)
{
    ...
    Console.WriteLine("Após uma recepção calarosa da nossa desenvolvedora, escolha uma destas opções abaixo");
    ...
    Console.WriteLine("6 - Hitórico de Operações");
    ...
    switch (operacaoSelecionada)
    {
        ...
        case "6":
            ...
            Console.WriteLine("Clique ENTER para que vc possa voltar ao inicio do programa!!");
